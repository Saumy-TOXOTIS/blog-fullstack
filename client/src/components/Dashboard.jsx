                ...
                >
                  ...
                  <div className="p-5 relative z-10">
                    ...
                    <div className="mt-5 flex items-center justify-between">
                      ...
                      {currentPostCommentsFlat.length === 0 ? <span>Click to load comments</span> : <span>{showComments[post._id] ? 'Hide' : 'Show'} Comments ({currentPostCommentsFlat.length})</span>}
                      </button>
